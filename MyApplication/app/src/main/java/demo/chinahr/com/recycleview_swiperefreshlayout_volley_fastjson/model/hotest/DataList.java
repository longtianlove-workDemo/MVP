...
public class DataList {
    ...
    private String name;//ta

    private String ratestar;//ta
    ...
    public void setNeed_points(String need_points){
    ...
    public void setAdaptproject(String adaptproject){
        this.adaptproject = adaptproject;
    }
    ...
    public void setManager_recommend(String manager_recommend){
        this.manager_recommend = manager_recommend;
    }
