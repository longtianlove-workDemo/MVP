...
public class LeftSlideDeleteRecyclerView extends RecyclerView {
    ...
    public LeftSlideDeleteRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public LeftSlideDeleteRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (isSlide && slidePosition != AdapterView.INVALID_POSITION
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    return true; // 拖动的时候RecyclerView不滚动
                case MotionEvent.ACTION_UP:
        ...
        // 否则直接交给RecyclerView来处理onTouchEvent事件
    ...
    /**
     * 当RecyclerView item滑出屏幕，回调这个接口 我们需要在回调方法removeItem()中移除该Item,然后刷新ListView
     */
